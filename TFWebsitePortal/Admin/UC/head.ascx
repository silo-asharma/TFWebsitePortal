<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="head.ascx.cs" Inherits="exportimportbidcp.Dashboard.UC.head" %>
 ...
 <!--*******************
  ...
  <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header" style="height:60px;">
            <a href="#" class="brand-logo">
                ...
                <img class="logo-compact" src="<%=    Session["logoUrl"] %>"  alt="">
                <img class="brand-title" src="<%=   Session["logoUrl"] %>"  alt="">
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar card-step1">
                               <%= pageName %> 
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="<%=    Session["ProfileUrl"] %>" width="20px" height="10px" alt="" />
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  <%--  <a href="./app-profile.html" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<%=URLDisplay %>"/login" class="dropdown-item ai-icon">
                                        <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    ***********************************-->
        ...
        Sidebar start
    ***********************************-->
        <div class="deznav" style="margin-top:25px;padding-top:25px;">
                ...
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="dashboard" aria-expanded="false" title="Dashboard">
                            ...
                            <span class="nav-text card-step7">Dashboard</span>
                        </a>
                    ...
                    <li>
                        <a href="candidate-interview-list?type=All" aria-expanded="false">
                            ...
                            <span class="nav-text">Request Swatches</span>
                        </a>
       ...
       <a href="candidate-interview-list?type=All" aria-expanded="false">
           <i class="flaticon-381-television"></i>
           <span class="nav-text">Download Catalogue</span>
       </a>

   </li>
                    <%--<li>
                        <a href="add-job" aria-expanded="false">
                            <i class="flaticon-381-edit"></i>
                            <span class="nav-text card-step6" >Create Jobs</span>
                        </a>

                    </li>
                    <li class="mm-show">
                        <a class="has-arrow ai-icon" id="TLink1" href="javascript:void()" aria-expanded="true">
                            <i class="flaticon-381-tab"></i>
                            <span class="nav-text">Library</span>
                        </a>
                        <ul aria-expanded="true" id="navbar" class="mm-show">

                            <li><a href="add-question" class="card-step3">Question</a></li>
                            <li><a href="add-evaluation" class="card-step4">Evaluation</a></li>
                            <li><a href="add-skills" class="card-step5">Skills</a></li>
                            <li><a href="add-category" class="card-step2">Category</a></li>
                  ...
                  <%--  <li>
                   ...
                   <%-- <li>
                        <a href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Manage AI &nbsp;<span style="font-size:10px;">(Coming Soon)</span></span>
                        </a>
                    ...
                    <li class="mm-active">
                        ...
                        <ul aria-expanded="false" class="mm-show">
                            <% if(Session["company_recid"].ToString()=="3"){ %>
                            <li><a href="User-Profile">Company Profile</a></li>
                        
                            <li><a href="User-Setting" class="card-step8">Manage Users</a></li>
                            <li><a href="Branding" class="card-step9">Branding</a></li>
                            <li><a href="Email-Setting" class="card-step10">Email Template</a></li>
                            <%} else{ %>
                           
                               
                               <li><a href="User-Setting">Manage Users</a></li>
                              <li><a href="Branding">Branding</a></li>
                              <li><a href="Email-Setting">Email Template</a></li>
                            <%} %>
                        </ul>
                    </li>
                      <li>
                        <a href="Billing" aria-expanded="false">
                            ...
                            <span class="nav-text">Billing  & Plans</span>
                        </a>
                 ...
                 <%--   </li>--%>
                    <li>
                    <%--    <a href="Search-Report" aria-expanded="false">
                            <i class="flaticon-381-network"></i>
           ...
           <%--         </li>--%>
                ...
                <div class="copyright">
                    <p><strong><%--<%=  Session["CompanyName"] %> --%>Dashboard</strong> © 2025 All Rights Reserved</p>
