app.controller('priceCtrl', function ($scope, $http) {
    ...
    $scope.getCompareGraph = function () {
        ...
        $http.get("http://localhost:54863/Search/GetMComparelist?pageIndex=" + $scope.pageIndex + "&pageSize=" + $scope.pageSizeSelected + "&mode=" + $scope.mode + "&year=" + $scope.year + "&from=" + $scope.from + "&to=" + $scope.to + "&header=" + $scope.header + "&keyword=" + $scope.keyword).then(
