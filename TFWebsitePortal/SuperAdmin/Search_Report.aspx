                            ...
                            <div class="card-body">
                                                    ...
                                                    <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%;padding:2px;">
                                                                <asp:TextBox ID="txtName" runat="server" Text=""  class="form-control" placeholder="Name"></asp:TextBox>
                                                                </td>
                                                             <td style="width: 50%;padding:2px;">
                                                                 <asp:DropDownList ID="ddlAllJob" runat="server" class="form-control" placeholder="Listed Jobs">
                                           <asp:ListItem Value="">Job Status</asp:ListItem>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="width: 50%;padding:2px;">   <asp:TextBox ID="txtEmail" runat="server" Text=""  class="form-control" placeholder="Email"></asp:TextBox>
                                             ...
                                             <asp:ListItem Value="0">Select Status</asp:ListItem>
                                               <asp:ListItem Value="Pass">Hired</asp:ListItem>
                                               <asp:ListItem Value="Fail">On Hold</asp:ListItem>
                                               <asp:ListItem Value="Undecided">Shortlisted</asp:ListItem>
                                              <asp:ListItem Value="Rejected">Rejected</asp:ListItem>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%;padding:2px;">
                                                                <asp:TextBox ID="txtPhone" runat="server" Text="" class="form-control" placeholder="Phone No"></asp:TextBox>
									...
									<div class="form-group m-0">
                                                      ...
                                                      &nbsp;&nbsp;&nbsp;          &nbsp;   
								                       ...
								                       <asp:Button ID="Button9" runat="server"  Text="Download" ValidationGroup="V1"  style="width:100px; border-color: lightgray; background-color:lightgray; color: white; border-radius: 12px; height: 35px;" OnClick="Button9_Click"   />
                                ...
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                         <a href="candidate-profile">   <i class="fa fa-eye" aria-hidden="true"></i></a>
