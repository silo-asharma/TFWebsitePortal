              ...
              <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" runat="server" id="EmailHead"></h4>
                            </div>
                            <div class="card-body">
                        ...
                        <%--        <h6 class="card-title border-bottom-with-margin">Send Email</h6>--%>
									...
									<div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEmail" runat="server" class="form-control" placeholder="Please enter Email Id(test.gmail.com,test2.gmail.com)"></asp:TextBox>
								            <br />
                                        <p runat="server" id="plink"></p>
