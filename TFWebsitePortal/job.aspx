<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="job.aspx.cs" Inherits="Extuent.job" %>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col">
                ...
                <!-- start navigation -->
                <div class="navigation" style="list-style-type:none;">
                    <ul>
                      <%--  <li style="list-style-type:none;"><a href="#" title="Features">Features</a></li>
                        <li style="list-style-type:none;"><a href="#" title="Clients">Clients</a></li>
                        <li style="list-style-type:none;"><a href="#" title="Login">Login</a></li>
                        <li style="list-style-type:none;"><a href="#" title="Pricing">Pricing</a></li>
                        <li style="list-style-type:none;"><a href="#" title="Get Demo">Get Demo</a></li>--%>
                    </ul>
                </div>
                <!-- end navigation -->
            </div>
