...
function getExportimportDataDetails() {
     aa = '';
     arrExportimportLabels.length = 0;
    brrTotalvalueExport.length=0;
    brrTotalvalueImport.length =0;
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "ExportImportList.aspx/GetListofCountry",
        data: "",
        dataType: "json",
        success: function (data) {
            if (data.d.length > 0) {
                ...
                $.each(items, function (index, val) {
                    ...
                    aa = "\"" + val.Country + "\"";
                    arrExportimportLabels.push(aa);
                    brrTotalvalueExport.push(parseInt(val.ExportData));
                    brrTotalvalueImport.push(parseInt(val.ExportData));
                });
...
$(function () {
  ...
  var options = {
    ...
    xaxis: {
      type: 'datetime',
      categories: ['01/01/1991', '01/01/1992', '01/01/1993', '01/01/1994', '01/01/1995', '01/01/1996', '01/01/1997', '01/01/1998', '01/01/1999', '01/01/2000', '01/01/2001', '01/01/2002', '01/01/2003', '01/01/2004', '01/01/2005', '01/01/2006', '01/01/2007', '01/01/2008']
    }
  }
  ...
  var options = {
    ...
    series: [{
      name: 'Export($)',
      data: generateDayWiseTimeSeries(0, brrTotalvalueExport.length)
    }, {
      name: 'Import($)',
      data: generateDayWiseTimeSeries(1, brrTotalvalueImport.length)
    }],
    markers: {
      size: 0,
      strokeColor: "#fff",
  ...
  var options = {
    ...
    colors: ["#007bff", "#ffc107", "#6c757d", "#dc3545", "#28a745", "#800080", "#FFFF00", "#00FF00", "#FF00FF", "#FFA500", "#800000", "#008000", "#43C6DB", "#8AFB17", "#9F000F", "#E41B17", "#F6358A", "#A23BEC", "#E238EC"],
    legend: {
      position: 'top',
  ...
  var options = {
    ...
    colors: ["#007bff", "#ffc107","#28a745","#6c757d"],
    grid: {
      borderColor: "rgba(77, 138, 240, .1)",
      padding: {
        top: 0,
