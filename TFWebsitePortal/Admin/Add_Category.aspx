<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Category.aspx.cs" Inherits="Extuent.Admin.Add_Category" EnableEventValidation="false"%>
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Category Library</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <div>
                                                    ...
                                                    <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 90%">
                                                                    <asp:TextBox ID="txtCat" runat="server" class="form-control" placeholder="Enter Category Name" required></asp:TextBox>
						           ...
						           &nbsp; <asp:Button ID="btnUpdate" runat="server" Text="Update"  usesubmitbehavior="false" Visible="false" OnClick="btnUpdate_Click" class="bg-orange" style="width: 90%; border-color: #FF7416; color: white; border-radius: 12px; height: 35px;"/>
                                    ...
                                    <tr>
                                        <td><%= j %></td>
                                        <td><%= categoryList[k].category_name %></td>
                                     
                     
                                      
                                         <td> 
                                             <a href="add-category?Edit=<%= categoryList[k].id %>">  <i class="fa fa-edit" aria-hidden="true"></i>  </a>    
                                      <a href="add-category?Del=<%= categoryList[k].id %>">  <i class="fa fa-trash" aria-hidden="true"></i> </a>
