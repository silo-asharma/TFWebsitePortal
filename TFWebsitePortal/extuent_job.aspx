<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="extuent_job.aspx.cs" Inherits="Extuent.extuent_job" %>
...
<div class="main-container">
        ...
        <div class="page-heading">
          <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <asp:TextBox ID="txtKeyword" class="form-control" runat="server" OnTextChanged="txtKeyword_TextChanged" AutoPostBack="true" placeholder="Search By Keyword.."   Font-Size="Small"></asp:TextBox>
                        
                                    </div>
                            <div class="col-xl-6 col-md-6">
                                   <asp:TextBox ID="txtSearch" class="form-control" runat="server" OnTextChanged="txtSearch_TextChanged" AutoPostBack="true" placeholder="Search By Location.."   Font-Size="Small"></asp:TextBox>
        ...
        <div class="job-listing">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <!-- start column -->
                    <div class="column">
                        <div class="job-text-min">
                        <div class="title">
                            <div class="row align-items-center">
                                <div class="col-sm">
                                    <p><%=  getCAtegoryName(JobpostList[k].job_type.ToString())  %></p>
                                </div>
                                <div class="col-sm-auto">
                                    <p>
                                       <%-- <a href="#job-listing<%= j%>" data-bs-toggle="modal" title="View details" class="view-details-link">
                                            View details
                                            <img src="images/icon_view_details.svg" width="33" height="33" alt="View details">
                                        </a>--%>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <h4><%=  JobpostList[k].job_title  %></h4>
                        <span class="loc"><%=  JobpostList[k].job_locations  %></span>
                        <p class="dec"><%= postdesc  %>....</p>
                            </div>
                        <div class="row align-items-center">
                            <div class="col-sm">
                                <p class="time"><img src="images/icon_location.svg" width="33" height="33" alt="View details"><%=  JobpostList[k].job_type  %></p>
                            </div>
                            <div class="col-sm-auto">
                                <div class="btn-col">
                                   <%-- <a href="#" title="share" class="share-link"><img src="images/icon_share.svg" width="33" height="33" alt="share"></a>--%>
                                    <a href="#job-listing<%= j%>" data-bs-toggle="modal" title="Apply Now" class="btn-outline">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="job-listing<%= j%>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="footer-logo">
                        ...
                        <!-- start imgb -->
                        <div class="imgb">
                         <p style="font-size:10px">Powered By</p>   <a href="https://extuent.com" title="Extuent"><img src="images/logo.png" style="width:80px;height:25px"  
                                    alt="Extuent"></a>
                        </div>
                        <!-- end imgb -->
                    </div>
