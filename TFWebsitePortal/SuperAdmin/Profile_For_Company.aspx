                                    ...
                                    <div class="card-body">
                                        <div class="profile-statistics mb-5">
                                            ...
                                            <div class="text-left">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <textarea id="txtCommentsarea" placeholder="enter Comment..." rows="3" style="width:100%" runat="server" visible="false"></textarea>
                                            ...
                                            <div >
                                                ...
                                                <table style="width:80%;visibility:hidden ">
                                                    <tr>
 ...
 <div class="position"><asp:Label ID="lblPost" runat="server" Text=""></asp:Label></div>
     ...
     <br />
       ...
       <div class="position" style="color:blue;"><asp:Button ID="btnViewRemarks" runat="server" Text="View/Download Resume" 
                      class="button"  OnClientClick="OpenWindow();" Visible="false"/>
