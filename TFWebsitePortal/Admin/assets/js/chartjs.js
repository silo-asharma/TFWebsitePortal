...
function getdataExportImport() {
    $.ajax({
        ...
        url: "advancesearch.aspx/getExportImportChartData",
        data: JSON.stringify({ Mode: Mode, Year: Year, MonthFrom: MonthFrom, MonthTo: MonthTo, ProductName: ProductName, HsCode: HsCode, Chapter: Chapter, Importer: Importer, Exporter: Exporter, Country: Country, Port: Port, Unit: Unit }),
        dataType: "json",
...
function getExportimportDataDetails() {                       //////// Line Graph for productsearch page
...
function getExportimportDataDetailsLinegraphadvanceSearch() {

    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "advancesearch.aspx/GetListofCountriesexportimport",
        data: JSON.stringify({ Mode: Mode, Year: Year, MonthFrom: MonthFrom, MonthTo: MonthTo, ProductName: ProductName, HsCode: HsCode, Chapter: Chapter, Importer: Importer, Exporter: Exporter, Country: Country, Port: Port, Unit: Unit }),
        dataType: "json",
        success: function (data) {
            if (data.d.length > 0) {
...
$(getExportimportDataDetailsLinegraphadvanceSearch);
